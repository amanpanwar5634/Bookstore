...
<div className="navbar">
  <div className="navbar-start">
    ...
    <a className="btn btn-ghost text-3xl ">BookStore</a>
  </div>
  ...
  <div className="navbar-center hidden lg:flex">
    ...
    <label className=" px-4 py-2 border rounded-md flex items-center gap-2">
  ...
  {/* sun icon */}
  <svg
    className="swap-off  px-1 h-10 w-8 fill-current"
    xmlns="http://www.w3.org/2000/svg"
    viewBox="0 0 24 24"
  ...
  {/* moon icon */}
  <svg
    className="swap-on h-10  px-1 w-8 fill-current"
    xmlns="http://www.w3.org/2000/svg"
    viewBox="0 0 24 24"
